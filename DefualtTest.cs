    ...
    public class DefualtTest
    {
        DefualtTest()
        {
            ...
            Comments = new []
            {
                ...
                {
                 UserId   = 1,
                 Text = "Какой прекрасный тест, всегда знала что та еще морковка.",
                 IsLike = true
                },
                new Comment()
                {
            ...
            Questions  = new[]
                {
                    new Question()
                    {
                    Text = "У вас много вазнообрахных Одежек?",
                    Answers = new[]
                    {
                        new Answer()
                        {
                    ...
                    Answers = new[]
                    {
                        new Answer()
                        {
                            Text = "Фу какая тут  грязь, Мерзоть!",
                            Cost = 1
                        },
                        new Answer()
                        {
                            Text = "Ай, бывало и хуже!",
                            Cost = 3
                        },
                        new Answer()
                        {
